...
public partial class Contexts {
    ...
    public void InitializeEntityIndices() {
        game.AddEntityIndex(new Entitas.EntityIndex<GameEntity, UnityEngine.Vector2Int>(
            TileId,
            game.GetGroup(GameMatcher.TileId),
            (e, c) => ((TileIdComponent)c).value));
    }
}

public static class ContextsExtensions {

    public static System.Collections.Generic.HashSet<GameEntity> GetEntitiesWithTileId(this GameContext context, UnityEngine.Vector2Int value) {
        return ((Entitas.EntityIndex<GameEntity, UnityEngine.Vector2Int>)context.GetEntityIndex(Contexts.TileId)).GetEntities(value);
    }
}
//------------------------------------------------------------------------------
// <auto-generated>
